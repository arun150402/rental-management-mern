...
export default function RegFarmer(){
  ...
  //localStorage.setItem('namw',render.result);
  ...
  const {name ,tempass, phnum, mail,pass,pic,picname}=farmer;
    ...
    return(
        ...
        <ul className="navbar--items">
          ...
          <li className="navbar--links sign">
            <Link to='/FarmerLogin' className="btn1">Sign In</Link>
          </li>
          <li className="navbar--links ">
            <Link to='/Register' >Sign Up as Owner</Link>
          </li>
        </ul>
